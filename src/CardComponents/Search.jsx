...
const Search = ({taskArr, setTaskArr, unfilteredTaskArr, setUnfilteredTaskArr}) => {
  ...
  return (
    <div class='searchbar'>
    <input onChange={(e) => handleSearch(e.target.value)} type="text" id="fname" name="fname" placeholder="Search..."></input>
